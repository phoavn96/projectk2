...
<section class="row flexbox-container">
  <div class="col-xl d-flex justify-content-center" style="padding: 80px">
                  ...
                  <div class="card rounded-0 mb-0 p-2">
                      ...
                      <div class="card-content">
                          <div class="card-body pt-0">
                            <form method="POST" action="{{URL::to('/do-signup')}}">
                              @csrf
...
{{--                                    <input type="text" class="ggg" name="phone" value="{{old('phone')}}" placeholder="Điền số điện thoại" required>--}}
                                    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="phone" value="{{ old('phone') }}" required autocomplete="phone">
                                ...
                                <button type="submit" class="btn btn-primary float-right btn-inline mb-50">Register</button></a>
