...
<div class="es-wrapper-color" style="background-color:#EFEFEF">
    ...
    <![endif]-->
    <?php
    use App\Order;$obj = Order::findOrFail($transaction);
    $total =0;
    ?>
                            ...
                            <table class="es-header-body"
                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="left"
                                        ...
                                        <!--[if mso]></td>
                                        <td style="width:20px"></td>
                                        <td style="width:370px" valign="top"><![endif]-->
                                                            ...
                                                            <td class="es-m-p0l es-m-txt-c" align="left"
                                                                ...
                                                                <a href="http://127.0.0.1:8000/" target="_blank"
                                                                   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#999999"><img
                                                                        src="https://res.cloudinary.com/trinhlh96/image/upload/v1599743814/wzbbkmpwytkuzufg3nds.png"
                                                                        alt="Logo Petshop" title="Logo Petshop"
                                                                        width="118"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'trebuchet ms', helvetica, sans-serif;font-size:30px;font-style:normal;font-weight:normal;color:#333333">
                                                                    Cám ơn Bạn đã mua hàng từ chúng tôi</h1></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
                                                                    ...
                                                                    @if($namegift == 1)
                                                                        Đang được xử lý
                                                                    @elseif($namegift == 2)
                                                                        Đang được vận chuyển
                                                                    @elseif($namegift == 3)
                                                                        Đã hoàn thành. Hãy cho chúng tôi biết cảm nhận của bạn sau khi sử dụng sản phẩm nhé
                                                                    @elseif($namegift == 4)
                                                                        Đã bị hủy
                                                                    @endif
                                                                    . Nếu bạn có bất kỳ câu
                                                                    hỏi nào, hãy gọi cho chúng tôi 0911549898.</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p20b" align="left"
                                                    ...
                                                    <table
                                                        ...
                                                        width="100%" cellspacing="0" cellpadding="0" bgcolor="#fef9ef"
                                                        role="presentation">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        ...
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <font style="vertical-align:inherit"><font
                                                                                    style="vertical-align:inherit">{{$transaction}}</font></font>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                        ...
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <font style="vertical-align:inherit"><font
                                                                                    style="vertical-align:inherit">{{$obj -> created_at}}</font></font>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                        ...
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <font style="vertical-align:inherit"><font
                                                                                    style="vertical-align:inherit">{{number_format($obj->total_money).' VNĐ'}}</font></font>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
                                                                    <font style="vertical-align:inherit"><font
                                                                            style="vertical-align:inherit"> {{ $obj -> shipping_address}}</font></font></p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p0r es-m-p20b" valign="top" align="center"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-left:20px"><h4
                               ...
                               @foreach($obj->order_detail as $detail)
                                <tr style="border-collapse:collapse">
                                    <td align="left"
                                        ...
                                        <table style="width:560px" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:178px" valign="top"><![endif]-->
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p0r es-m-p20b" valign="top" align="center"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;font-size:0"><a
                                                                    href="http://127.0.0.1:8000/chi-tiet-san-pham/{{$detail ->product_id}}" target="_blank"
                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#D48344"><img
                                                                        src="{{\App\Product::find($detail ->product_id)->large_photo}}"
                                                                        class="adapt-img"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0"><p
                                                                ...
                                                                <table
                                                                    ...
                                                                    cellpadding="1" border="0" role="presentation">
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0"><font
                                                                                style="vertical-align:inherit"><font
                                                                                    style="vertical-align:inherit">{{\App\Product::find($detail ->product_id)->product_name}}</td>
                                                                        <td style="padding:0;Margin:0;width:60px;text-align:center">
                                                                            <font style="vertical-align:inherit"><font
                                                                                    style="vertical-align:inherit">{{$detail ->quantity}}</font></font>
                                                                        </td>
                                                                        <td style="padding:0;Margin:0;width:100px;text-align:center">
                                                                            <font style="vertical-align:inherit"><font
                                                                                    style="vertical-align:inherit">{{number_format($detail ->unit_price*$detail ->quantity).' VNĐ'}}</font></font>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
                                                            ...
                                                            <td align="right" style="padding:0;Margin:0">
                                                                <table
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        ...
                                                                        <td style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px">
                                                                            <font style="vertical-align:inherit"><font
                                                                                    style="vertical-align:inherit">{{number_format($total).' VNĐ'}}</font></font>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px">
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px">
                                                                            <b>Tổng thanh toán</b></td>
                                                                        <td style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px;color:#D48344">
                                                                            <strong><font
                                                                                    style="vertical-align:inherit"><font
                                                                                        style="vertical-align:inherit">{{number_format($obj->total_money).' VNĐ'}}</font></font></strong>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-p0l es-m-txt-c" align="left"
                                                                style="padding:0;Margin:0;font-size:0px"><a
                                                                    ...
                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#333333"><img
                                                                        src="https://res.cloudinary.com/trinhlh96/image/upload/v1599743814/wzbbkmpwytkuzufg3nds.png"
                                                                        alt="Logo Petshop" title="Logo Petshop"
                                                                        width="108"
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-txt-c" align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
                                                                    <strong>8 Tôn Thất Thuyết, Mỹ Đình, Từ Liêm, Hà
                                                                        Nội</strong></p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-txt-c" align="left"
                                                                style="padding:0;Margin:0;padding-top:5px"><p
                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">
                                                                    <a target="_blank" href="tel:123456789"
                                                                       style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#333333">0</a>911549898<br>baolangsa18@gmail.com
                                                                </p></td>
                                                        </tr>
                                                    </table>
                                                </td>
