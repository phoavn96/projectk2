...
@section('content')
    ...
    <section id="data-thumb-view" class="data-thumb-view-header">
        <div class="add-new-data">
            <form role="form" action="{{URL::to('admin/discount')}}" method="post" id="product_form">
                {{csrf_field()}}
                        ...
                        <div class="data-fields px-2 mt-1">
                            <div class="row">
                                ...
                                <div class="col-sm-12 data-field-col">
                                    ...
                                    <input type="text" class="form-control" id="data-name" name="value" value="{{old('value')}}">
                                    @if($errors -> has('value'))
                                        <span class="error" style="color: red">
                                {{$errors -> first('value')}}
                                    </span>
                                ...
                                <div class="col-sm-12 data-field-col">
                                    ...
                                    <input type="text" class="form-control" id="data-end_time" name="end_time" value="{{old('end_time')}}" placeholder="năm-tháng-ngày">
