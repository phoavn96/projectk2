$(document).ready(function () {
    var e = ["#7367F0", "#28C76F", "#EA5455", "#FF9F43", "#00cfe8"], t = !1;
    ...
    var n = {
        ...
        yaxis: {title: {text: "$ (thousands)"}, opposite: t},
        fill: {opacity: 1},
        tooltip: {
            y: {
    ...
    var i = {
        ...
        legend: {offsetY: -10},
        xaxis: {type: "datetime"},
        yaxis: {min: 0, tickAmount: 5, title: {text: "Points"}, opposite: t},
        tooltip: {
    ...
    var s = {
        chart: {height: 350, type: "candlestick"}, colors: e, series: [{
        ...
        }], xaxis: {type: "datetime"}, yaxis: {tickAmount: 5, tooltip: {enabled: !0}, opposite: t}
    };
    ...
    var c = {
        ...
        series: [{
            name: "Product1",
            data: d(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})
        }, {
            name: "Product2",
            data: d(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})
        }, {
            name: "Product3",
            data: d(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})
        }, {name: "Product4", data: d(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})}],
        fill: {type: "gradient"},
        xaxis: {tickAmount: 12, type: "datetime", labels: {rotate: 0}},
        yaxis: {max: 70, tickAmount: 5, opposite: t},
        theme: {palette: "palette2"}
    };
    new ApexCharts(document.querySelector("#bubble-chart"), c).render();
    var l = {
        chart: {height: 350, type: "scatter", zoom: {enabled: !0, type: "xy"}},
        colors: e,
        series: [{
            name: "SAMPLE A",
    ...
    function p(e, t) {
        for (var a = 0, r = []; a < e;) {
            var n = "w" + (a + 1).toString(), o = Math.floor(Math.random() * (t.max - t.min + 1)) + t.min;
            r.push({x: n, y: o}), a++
        }
        return r
    }
    ...
    var w = {
        ...
        dataLabels: {enabled: !1},
        colors: ["#7367F0"],
        series: [{name: "Metric1", data: p(18, {min: 0, max: 90})}, {
            name: "Metric2",
            data: p(18, {min: 0, max: 90})
        }, {name: "Metric3", data: p(18, {min: 0, max: 90})}, {
            name: "Metric4",
            data: p(18, {min: 0, max: 90})
        }, {name: "Metric5", data: p(18, {min: 0, max: 90})}, {
            name: "Metric6",
            data: p(18, {min: 0, max: 90})
        }, {name: "Metric7", data: p(18, {min: 0, max: 90})}, {
            name: "Metric8",
            data: p(18, {min: 0, max: 90})
        }, {name: "Metric9", data: p(18, {min: 0, max: 90})}],
        yaxis: {opposite: t}
    };
